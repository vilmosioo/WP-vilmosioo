...
class VilmosIoo extends Hyperion{	
	...
	*/
	...
	function remove_footer_admin () {
		...
		echo 'Theme designed and developed by <a href="http://vilmosioo.co.uk" target="_blank">Vilmos Ioo</a> and powered by <a href="http://wordpress.org" target="_blank">WordPress</a>. Version v1.3.8';
	}
	...
	function add_scripts_and_styles(){
		...
		wp_register_script( 'default', THEME_PATH.'/js/script.js', array(), '1.3.8', true ); 
		wp_register_script( 'modernizr', THEME_PATH.'/js/vendor/modernizr/modernizr.js', array(), '2.6.2', true ); 
		wp_register_script( 'webgl', THEME_PATH.'/js/webgl.js', array('default'), '1.3.8', true);
		wp_register_script( 'play', THEME_PATH.'/js/play.js', array('default'), '1.3.8', true);
		wp_register_script( 'gameoflife', THEME_PATH.'/js/gameoflife.js', array('default'), '1.3.8', true);
