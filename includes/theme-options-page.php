		...
		// TO DO Add to variable
     	...
     	foreach( $tabs as $tab => $name ){
          	if ( $tab == $current ){
       		...
       		$links[] = "<a class='nav-tab $active_class' href='?page=hyperion&tab=$tab'>$name</a>";
       	}
	...
	*/
	function register_mysettings() {
		...
		if( $tab == 'tab1'){
			...
			add_settings_section( 'options_section_1', '', array(&$this, 'settings_section_setup'), 'hyperion' ); 
			add_settings_field('option_name_1', 'Sample option 1', array(&$this, 'option_1_setup'), 'hyperion', 'options_section_1');
		}
		if( $tab == 'tab2'){
			//add_settings_section( $id, $title, $callback, $page ); 
			add_settings_section( 'options_section_2', '', array(&$this, 'settings_section_setup'), 'hyperion' ); 
			add_settings_field('option_name_2', 'Sample option 2', array(&$this, 'option_2_setup'), 'hyperion', 'options_section_2');
		}
	}
